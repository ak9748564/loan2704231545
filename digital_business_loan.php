...
<head>
    ...
    <title>Digital Business Loan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        #dpl {
            height: 100%;
            background-image: url('images/digital-business-loan.jpg');
    ...
    <div id="dpl">
        ...
        <div id="section2">
            <div class="inner_section1">
                <h1>Become an Elite member to get Instant Business Loan Offer</h1>
                <ul style="margin-top:20px;">
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16" style="color: #ed940d;">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                        </svg>Lowest interest rates ever (starting 11.5% pa.)</li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16" style="color: #ed940d;">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                        </svg>Disbursal up to Rs.1 Crore</li>
                </ul>
            </div>
            <div class="inner_section1">
                <form action="">
                    ...
                    <div style="display:flex;">
                        <div style="display: block;width:100%;font-family: 'Poppins', sans-serif;font-size: 14px;line-height: 24px;font-weight: 400;color: #3a3a3a;">
                            ...
                            <a href="">
                                <div style="display: inline-block;border:2px solid black;border-radius:6px;padding:0px 10px;font-family: 'Poppins', sans-serif;font-size: 11px;line-height: 28px;font-weight: 600;color: #1f1f1f;">Login</div>
                            </a>
                        </div>
                        <div style="display:inline-block;min-width:142px;height:30px;font-family: 'Poppins', sans-serif;font-size: 11px;line-height: 28px;font-weight: 600;color: #4c5667;border:1px solid #ebebeb;border-radius:5px;padding:0px 10px;">LOAN CALCULATOR</div>
                    </div>
                </form>
            </div>
        </div>
        <div id="contact" style="position: absolute;top: 60px;right: 20px;background: white;padding: 15px;border-radius:6px;box-shadow:1px 1px 15px #3a3a3a;display:none;cursor:pointer;">
        <a href="" style="display: block;color:#1f1f1f;text-decoration:none;font-family:'Poppins',sans-serif;font-size:13px;line-height:26px;font-weight:400;"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
            </svg>+91-73594-68774</a>
        <a href="" style="display: block;color:#1f1f1f;text-decoration:none;font-family:'Poppins',sans-serif;font-size:13px;line-height:26px;font-weight:400;"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
    ...
    <div id="section3">
        <div class="inner_section1">
            <div class="inner_small_section1">
                <h1>Small Business Person Eligibility Criteria</h1>
                <p>(1) Minimum age 21 years (2) Minimum 1 year IT return (3) 1 year business stability</p>
            </div>
            <div class="inner_small_section1">
                <h1>Audited Report Person Eligibility Criteria</h1>
                <p>(1) Minimum age 21 years (2) 1 crore plus yearly turnover (3) Minimum 2 year audited Report</p>
            </div>
        </div>
        <div class="inner_section1">
            <div class="inner_small_section1">
        ...
        <div class="inner_section1">
            <div class="inner_small_section1">
                <h1>Why My24Loan?</h1>
                <p>(1) Per month 1000+ happy customers (2) Minimum documents - depend customer profile (3) Compare to multiple banks (4) Flexible repayment terms 1 to 6 years (5) Processing fees & insurance depand banks</p>
            </div>
        </div>
    </div>
    <script>
