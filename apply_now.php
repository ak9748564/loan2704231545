...
<head>
    ...
    <style>
        * {
        ...
        #dpl #section2 .inner_section1:nth-child(2) >div:nth-child(1) label {
            font-family: 'Poppins', sans-serif;
            font-size: 13px;
            line-height: 23px;
            font-weight: 500;
        ...
        #dpl #section2 .inner_section1:nth-child(2) > div:nth-child(1) b {
            font-family: 'Poppins', sans-serif;
            font-size: 13px;
            line-height: 23px;
            font-weight: 600;
        ...
        #dpl #section2 .inner_section1:nth-child(2) > form > div:nth-child(2){
        ...
        #dpl #section2 .inner_section1:nth-child(2) > form >label {
            font-family: 'Poppins', sans-serif;
            font-size: 13px;
            line-height: 23px;
            font-weight: 500;
        ...
        #dpl #section2 .inner_section1:nth-child(2) > form >input{
            height: 55px;
            margin-bottom: 10px;
            border-radius: 6px;
...
<body>
    <div id="dpl">
        ...
        <div id="section2">
            ...
            <div class="inner_section1">
                <img src="images/mobile-otp.png" alt="">
                <form action="check_eligibility.php">
                    <div style="display: flex;margin-top:20px;"><label for="">Mobile No.:&nbsp;</label><b>9953952112</b></div>
                    <label for="">Please enter the OTP you get on this number:</label>
                    <input type="text">
                    <div>Don't received OTP? &nbsp;<a href="" style="text-decoration: none;">Resend OTP</a></div>
                    <input type="submit" value="VERIFY" style="display: block;width:100%;font-family: 'Poppins', sans-serif;font-size: 12px;line-height: 12px;font-weight: 600;color: #ffffff;background-color:#ef8a09;height:40px;">
